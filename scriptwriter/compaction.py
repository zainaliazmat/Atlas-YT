...
(chat.distill_and_save), which is what persists Marlow's durable memory at session
...
COMPACTION_SYSTEM = (
    ...
    "scriptwriter co-worker who must remember them across sessions."
)
...
def _compaction_user_prompt(existing_summary: str, turns: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        "kinds of videos and topics they make, their audience and channel, their "
        "taste and standards (pacing, tone, how much they care about a hook or a "
        "tangent), decisions made, and angles that landed. DISCARD greetings, small "
        "talk, pleasantries, and transient chatter. Merge with what you already "
        "knew; don't repeat. Output ONLY the updated memo as concise prose — no "
