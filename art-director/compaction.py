...
(chat.distill_and_save), which is what persists Iris's durable memory at session
...
COMPACTION_SYSTEM = (
    ...
    "art-director co-worker who must remember them across sessions."
)
...
def _compaction_user_prompt(existing_summary: str, turns: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        "kinds of videos and topics they make, their channel and audience, their "
        "taste and standards (palette and type preferences, how much motion they "
        "tolerate, references they like), decisions made, and looks that landed. "
