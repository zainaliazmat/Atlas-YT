...
(chat.distill_and_save), which is what persists Quill's durable memory at session
...
COMPACTION_SYSTEM = (
    ...
    "editorial coach co-worker who must remember them across sessions."
)
...
def _compaction_user_prompt(existing_summary: str, turns: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        "taste and standards (hooks, clarity, claim support, how much they care "
        "about a tangent or a strong arc), decisions made, and angles that landed. "
        "DISCARD greetings, small talk, pleasantries, and transient chatter. Merge "
        "with what you already knew; don't repeat. Output ONLY the updated memo as "
        "concise prose — no preamble, no commentary."
    )
