...
# --- beat 13: diagram-draw (edges self-draw + nodes pop in) --------------------
DIAGRAM_DRAW = """/* motion-library beat: diagram-draw
...
# --- beat 12: timeline-rail (rail draws across + sequential node reveals) ------
TIMELINE_RAIL = """/* motion-library beat: timeline-rail
...
# --- beat 11: map-draw (self-drawing route + pin pop) -------------------------
MAP_DRAW = """/* motion-library beat: map-draw
...
BEATS: dict[str, tuple[str, str, str]] = {
    ...
    "map-draw": ("makeMapDraw", "map-draw.js", MAP_DRAW),
    "timeline-rail": ("makeTimelineRail", "timeline-rail.js", TIMELINE_RAIL),
    "diagram-draw": ("makeDiagramDraw", "diagram-draw.js", DIAGRAM_DRAW),
}
