"""Durable, provider-agnostic state for Flux — the source of truth on disk.

Two things live through this module:

1. Flux's chat memory ("Talk to Flux"). Across sessions, Flux's ONLY long-term
...
def append_turn(state: dict[str, Any], role: str, content: str) -> None:
    """Append one turn. role is 'user' or 'flux' (kept provider-neutral)."""
